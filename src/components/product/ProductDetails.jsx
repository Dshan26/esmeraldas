...
/**
 * Product details panel showing full description, technical specs, price, and WhatsApp buy button.
 *
...
export default function ProductDetails({ product }) {
  ...
  const fullDescription = product.fullDescription?.[i18n.language] || product.fullDescription?.es || '';
  ...
  const specs = [
    { label: t('product.carats'), value: product.carats },
    { label: t('product.cut'), value: product.cut },
    { label: t('product.clarity'), value: product.clarity },
    { label: t('product.origin'), value: product.origin },
  ];

  return (
    <div className={styles.details} data-testid="product-details">
      ...
      <button
        ...
        type="button"
        aria-label={`${t('product.buyWhatsApp')} - ${productName}`}
      >
